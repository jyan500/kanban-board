...
import { ListResponse, Notification, Toast } from "../../types/common"
...
export const Notifications = ({fromDashboard}: Props) => {
	...
	return (
		<div className = "tw-flex tw-flex-col tw-gap-y-4">
			{!fromDashboard ? <h1 className="dark:tw-text-white">Notifications</h1> : <h2 className = "dark:tw-text-white">Notifications</h2>}
            {
                !fromDashboard ? 
