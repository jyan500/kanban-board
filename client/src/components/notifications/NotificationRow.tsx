...
export const NotificationRow = ({notification}: Props) => {
	...
	return (
		<div className = {`${!notification?.isRead ? "tw-bg-gray-50" : ""} tw-relative hover:tw-bg-gray-50 tw-p-2 tw-flex tw-flex-row tw-gap-x-2 tw-items-center tw-border tw-border-gray-200 tw-rounded-md tw-group`}>
