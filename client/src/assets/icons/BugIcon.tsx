...
export const BugIcon = ({className}: Props) => {
	return (
		<svg 
			...
			<path fill-rule="evenodd" clip-rule="evenodd" d="M84 56C84 71.4653 71.4653 84 56 84C40.5347 84 28 71.4653 28 56C28 40.5347 40.5347 28 56 28C71.4653 28 84 40.5347 84 56Z" fill="white"/>
		</svg>
	)
}